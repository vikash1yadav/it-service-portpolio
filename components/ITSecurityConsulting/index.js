              ...
              <div className="service-details__left">
                ...
                <div className="service-details__need-help">
                  <div
                    ...
                    style={{
                      backgroundImage:
                        "url(../../assets/images/backgrounds/Hnet.com-image-_4_.webp)"
                    }}
                  ></div>
            ...
            <div className="col-xl-8 col-lg-7">
              <div className="service-details__right">
                <div className="service-details__img">
                  <img
                    src="../../assets/images/services/security-770x445.webp"
                    alt=""
                  />
                </div>
                  ...
                  <div className="row">
                    <div className="col-xl-6">
                      <div className="service-details__benefits-img">
                        <img
                          src="../../assets/images/services/Hnet.com-image-_3_.webp"
                          alt=""
                        />
                      </div>
                    </div>

              ...
              <div className="service-details__left">
                ...
                <div className="service-details__need-help">
                  <div
                    ...
                    style={{
                      backgroundImage:
                        "url(../../assets/images/backgrounds/training-389.webp)"
                    }}
                  ></div>
            ...
            <div className="col-xl-8 col-lg-7">
              <div className="service-details__right">
                <div className="service-details__img">
                  <img
                    src="../../assets/images/backgrounds/training-770x445 (2).webp"
                    alt=""
                  />
                </div>
                  ...
                  <div className="row">
                    <div className="col-xl-6">
                      <div className="service-details__benefits-img">
                        <img
                          src="../../assets/images/backgrounds/training-330x239.webp"
                          alt=""
                        />
                      </div>
                    </div>

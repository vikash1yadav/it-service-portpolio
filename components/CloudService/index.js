              ...
              <div className="service-details__left">
                ...
                <div className="service-details__need-help">
                  <div
                    ...
                    style={{
                      backgroundImage:
                        "url(../../../assets/images/services/cloud-computing-370x385.webp)"
                    }}
                  ></div>
            ...
            <div className="col-xl-8 col-lg-7">
              <div className="service-details__right">
                <div className="service-details__img">
                  <img
                    src="../../../assets/images/backgrounds/Hnet.com-image-_3_.webp"
                    alt=""
                  />
                </div>
                  ...
                  <div className="row">
                    <div className="col-xl-6">
                      <div className="service-details__benefits-img">
                        <img
                          src="../../../assets/images/services/Cloud-computing-370x239 (1).webp"
                          alt=""
                        />
                      </div>
                    </div>
